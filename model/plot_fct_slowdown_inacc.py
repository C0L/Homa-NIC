...
if __name__ == '__main__':
    ...
    axs[0].plot(xs_slowdown[:], ys_slowdown, label=cfg['util'])
    #axs[0].set_xlim((0, 50))
    ...
    sort = sorted(zip(xs_fct, ys_fct))
    print(sort)

    xs_fct, ys_fct= zip(*sort)

    axs[1].plot(xs_fct, ys_fct, label=cfg['util'])
    #axs[1].set_xlim((0, 50))
    ...
    axs[2].plot(xs_inacc, ys_inacc, label=cfg['util'])
