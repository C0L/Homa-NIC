...
// 
//         dut.io.newDmaMap.valid.poke(true.B)
// 
//         dut.io.newDmaMap.bits.pcie_addr.poke(transaction.U)
//         dut.io.newDmaMap.bits.port.poke(transaction.U)
//         dut.io.newDmaMap.bits.map_type.poke(0.U)
// 
//         dut.clock.step()
// 
//         dut.io.newDmaMap.valid.poke(true.B)
// 
//         dut.io.newDmaMap.bits.pcie_addr.poke((transaction + 16384).U)
//         dut.io.newDmaMap.bits.port.poke(transaction.U)
//         dut.io.newDmaMap.bits.map_type.poke(1.U)
// 
//         dut.clock.step()
// 
//         dut.io.newDmaMap.valid.poke(true.B)
// 
//         dut.io.newDmaMap.bits.pcie_addr.poke((transaction + 32768).U)
//         dut.io.newDmaMap.bits.port.poke(transaction.U)
//         dut.io.newDmaMap.bits.map_type.poke(2.U)
// 
//         dut.clock.step()
//       }
// 
//       dut.io.newDmaMap.valid.poke(false.B)
// 
//       for (transaction <- 0 to 16383) {
