...
void dma_ingress(homa_t * homa,
  ...
  // TODO decouple maxi from streaming

  // Control for this function should be bundled with the params?
  //#pragma HLS INTERFACE mode=ap_ctrl_chain port=params
...
#pragma HLS PIPELINE II=1
  ...
  // TODO need homa.mtu? int max_pkt_data = IPV6_HEADER_LENGTH - sizeof(data_header_t); // Does the message fit in a single packet?
