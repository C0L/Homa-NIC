...
/* psdpram_rd - simplisitc fixed width interface to psdram module.
 * This assumes the corresponding segmented memory is parameterized
 * with a 512 bit segmented size, 2 segments, and 11 bit address per
 * segment.
 */
