...
#pragma HLS interface mode=m_axi port=host offset=off num_read_outstanding=256 num_write_outstanding=1 max_read_burst_length=1 max_write_burst_length=1
	...
	dma_req(DMA_R_REQ_DATA) = *(host + (dma_req(DMA_R_REQ_HOST_ADDR) / 64));
