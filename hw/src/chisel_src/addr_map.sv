...
module addr_map(
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin
      if ((`PRINTF_COND_) & dma_w_meta_i_reg_1_valid & ~reset) begin
        automatic logic [3:0][7:0] _GEN_0 = '{8'h3F, 8'h61, 8'h68, 8'h63};
        automatic logic [3:0][7:0] _GEN_1 = '{8'h3F, 8'h74, 8'h32, 8'h32};
        automatic logic [3:0][7:0] _GEN_2 = '{8'h3F, 8'h65, 8'h63, 8'h68};
        automatic logic [3:0][7:0] _GEN_3 = '{8'h3F, 8'h6D, 8'h20, 8'h20};
        automatic logic            _GEN_4 =
          _metadata_maps_ext_R0_data[81:80] == 2'h2
          | _metadata_maps_ext_R0_data[81:80] == 2'h1
          | _metadata_maps_ext_R0_data[81:80] == 2'h0;
        $fwrite(32'h80000002,
                "meta_map_out = dma_map_t(pcie_addr -> %d, port -> %d, map_type -> %c%c%c%c%c%c%c%c).pcie_addr\n",
                _metadata_maps_ext_R0_data[63:0], _metadata_maps_ext_R0_data[79:64],
                _GEN_3[_metadata_maps_ext_R0_data[81:80]],
                _GEN_2[_metadata_maps_ext_R0_data[81:80]],
                _GEN_1[_metadata_maps_ext_R0_data[81:80]],
                _GEN_0[_metadata_maps_ext_R0_data[81:80]], _GEN_4 ? 8'h5F : 8'h3F,
                _GEN_4 ? 8'h6D : 8'h3F, _GEN_4 ? 8'h61 : 8'h3F, _GEN_4 ? 8'h70 : 8'h3F);
        $fwrite(32'h80000002,
                "meta_map_out = dma_write_t(pcie_write_addr -> %d, data -> %d, length -> %d, port -> %d).port\n",
                dma_w_meta_i_reg_1_bits_pcie_write_addr, dma_w_meta_i_reg_1_bits_data,
                dma_w_meta_i_reg_1_bits_length, dma_w_meta_i_reg_1_bits_port);
      end
    end // always @(posedge)
  `endif // not def SYNTHESIS
  wire         _GEN_5 = new_dma_map_i_reg_0_bits_map_type == 2'h0;
  wire         _GEN_6 = new_dma_map_i_reg_0_bits_map_type == 2'h1;
  always @(posedge clock) begin
  ...
  mem_16384x82 h2c_data_maps_ext (
    ...
    .W0_en   (new_dma_map_i_reg_0_valid & _GEN_5),
    .W0_clk  (clock),
    .W0_data (_GEN)
  );
  mem_16384x82 c2h_data_maps_ext (
    ...
    .W0_addr (new_dma_map_i_reg_0_bits_port[13:0]),
    .W0_en   (new_dma_map_i_reg_0_valid & ~_GEN_5 & _GEN_6),
    .W0_clk  (clock),
    .W0_data (_GEN)
  );
  mem_16384x82 metadata_maps_ext (
    ...
    .W0_addr (new_dma_map_i_reg_0_bits_port[13:0]),
    .W0_en
      (new_dma_map_i_reg_0_valid & ~(_GEN_5 | _GEN_6)
  ...
  assign io_dma_r_req_o_valid = dma_r_req_i_reg_0_valid;
  assign io_dma_r_req_o_bits_pcie_read_addr =
    dma_r_req_i_reg_0_valid
      ? _h2c_data_maps_ext_R0_data[63:0] + io_dma_r_req_i_bits_pcie_read_addr
      : 64'h0;
  assign io_dma_r_req_o_bits_cache_id =
    dma_r_req_i_reg_0_valid ? io_dma_r_req_i_bits_cache_id : 10'h0;
  assign io_dma_r_req_o_bits_message_size =
    dma_r_req_i_reg_0_valid ? io_dma_r_req_i_bits_message_size : 20'h0;
  assign io_dma_r_req_o_bits_read_len =
    dma_r_req_i_reg_0_valid ? io_dma_r_req_i_bits_read_len : 12'h0;
  assign io_dma_r_req_o_bits_dest_ram_addr =
    dma_r_req_i_reg_0_valid ? io_dma_r_req_i_bits_dest_ram_addr : 20'h0;
  assign io_dma_r_req_o_bits_port =
    dma_r_req_i_reg_0_valid ? io_dma_r_req_i_bits_port : 16'h0;
endmodule
